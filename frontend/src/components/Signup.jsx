    ...
    <section>
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12 z-10">
        <section className="relative flex h-32 items-end lg:bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="https://images.unsplash.com/photo-1625631980626-c4616c1b0257?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            Sign up below and dive into a world of exciting features and endless possibilities!
            </p>
          </div>
        </section>
            ...
            >
              <div className="col-span-6">
                ...
                <input
                  ...
                  className="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                  required
                />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <div className="relative">
                  <input
                    ...
                    className="rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                    required
                  />
              ...
              <div className="col-span-6 flex flex-col items-start gap-4">
                <button
                  disabled={isLoading}
                  className="mt-2 inline-block shrink-0 rounded-md border border-fuchsia-600 bg-fuchsia-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-fuchsia-600 focus:outline-none focus:ring active:text-blue-500"
                >
