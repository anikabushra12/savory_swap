...
const FryingpanSpinner = ({ extraClassName }) => {
  return (
    <div className={`${styles.body} ${extraClassName}`}>
      <svg
        className={styles.pl}
        viewBox="0 0 128 128"
        width="128px"
      ...
      >
        ...
        <g fill="currentColor">
          ...
          <g fill="hsla(223,10%,70%,0)">
            <g className={styles.pl__drop1}>
              <circle className={styles.pl__dropInner} cx="13" cy="60" r="2" />
            </g>
            <g className={styles.pl__drop2}>
              <circle className={styles.pl__dropInner} cx="13" cy="60" r="2" />
            </g>
            <g className={styles.pl__drop3}>
              <circle className={styles.pl__dropInner} cx="67" cy="72" r="2" />
            </g>
            <g className={styles.pl__drop4}>
              <circle className={styles.pl__dropInner} cx="67" cy="72" r="2" />
            </g>
            <g className={styles.pl__drop5}>
              <circle className={styles.pl__dropInner} cx="67" cy="72" r="2" />
            </g>
          </g>
...
export default FryingpanSpinner;
