    ...
    >
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            {/* <input
              ...
              className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:border-transparent"
              value={recipe.photo}
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {recipe.tags.map((tag, index) => (
                <div key={index} className="flex items-center gap-2">
                  <input
                    ...
                    className="w-32 px-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:border-transparent"
                    required
                  />
              ...
              <div className="flex gap-2">
                <button
                  type="button"
                  onClick={addTag}
                  className="text-fuchsia-600 hover:text-fuchsia-900 text-sm"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        {recipe.ingredients.map((ingredient, index) => (
          <div key={index} className="flex gap-4 items-center mb-2">
            <input
              ...
              className="flex-1 px-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:border-transparent"
              required
            />
            <input
              type="text"
      ...
      <div className="text-right">
        <button
          type="submit"
          disabled={isLoading}
          className="inline-block px-6 py-2 text-white bg-fuchsia-600 hover:bg-fuchsia-700 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:ring-opacity-50"
        >
