    ...
    <div className="flex flex-col items-center space-y-4">
      ...
      <label className="block">
        <input
          ...
          accept="image/*"
        />
        <span className="inline-block px-6 py-2 bg-purple-500 text-white font-medium text-sm leading-tight uppercase rounded shadow-md hover:bg-purple-600 hover:shadow-lg focus:bg-purple-600 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor-pointer">
          Choose File
        </span>
      </label>
