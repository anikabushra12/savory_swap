  ...
  return (
    <div className="p-4 w-96 bg-white rounded-lg shadow-md my-4 mb-8">
      ...
      <button
        ...
        disabled={loading}
        className="mt-2 w-full py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-fuchsia-600 hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-500"
      >
